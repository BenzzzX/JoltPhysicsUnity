namespace Jolt
{
    ...
    public readonly partial struct ShapeSettings
    {
        ...
        /// <summary>
        /// Reinterpret RotatedTranslatedShapeSettings as a generic ShapeSettings instance.
        /// </summary>
        /// <remarks>
        /// This does not reallocate the shape settings; the underlying pointer is the same.
        /// </remarks>
        public static implicit operator ShapeSettings(RotatedTranslatedShapeSettings settings)
        {
            return new ShapeSettings(settings.Handle.Reinterpret<JPH_ShapeSettings>());
        }
    }
